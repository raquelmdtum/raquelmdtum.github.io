...
<body>
  <div class="main-content">
    ...
    Our analysis dives deep into a dataset of UFO sightings from across the United States, spanning several decades. Through visualizations, we aim to answer these questions:
    ...
    <ul>
      ...
      <li>Cross-referencing with pop culture/media spikes:</strong> Could movie releases or news coverage be influencing sighting reports? COULD BE FUN </li>
    </ul>


    <h2>Geographic Hotspots: Mapping the Sightings</h2>
